...
function LogoMark() {
  return (
    <div className="flex items-center gap-3" data-testid="brand-campus">
      <div className="relative flex h-12 w-12 items-center justify-center overflow-hidden rounded-[14px] bg-[#F9F6F0] shadow-[4px_4px_0_#D99A2B]">
        <img
...
function VerificationGate({ status }: { status: VerificationStatus }) {
  ...
  > = {
    pending: {
      ...
      detail: t("verification.pending.detail"),
      tone: "bg-[#E9DCC8] text-[#725A4A]",
    },
    suspended: {
      title: t("verification.suspended.title"),
      detail: t("verification.suspended.detail"),
      tone: "bg-[#F6DDD6] text-[#8F3D2E]",
    },
    expired: {
      title: t("verification.expired.title"),
      detail: t("verification.expired.detail"),
      tone: "bg-[#E9DCC8] text-[#725A4A]",
    },
  };
  const copy =
  ...
  return (
    <div className="campus-shell flex min-h-[100dvh] flex-col bg-[#F5F0E6]">
      ...
      <main className="mx-auto flex w-full max-w-[760px] flex-1 items-center px-5 py-14 md:px-10">
        <section className="w-full reveal">
          <div className="mb-4 font-mono-campus text-[10px] font-bold uppercase tracking-[.2em] text-[#E76F51]">
            {t("page.identity.eyebrow")} / {t("page.identity.title")}
          </div>
          <h1 className="font-display text-4xl font-bold leading-tight tracking-[-.06em] text-[#18332C] md:text-6xl">
            {copy.title}
          </h1>
  ...
  return (
    <div className="relative flex min-h-[100dvh] flex-col items-center justify-center overflow-hidden bg-[#F5F0E6] px-4 py-10">
      ...
      <div className="relative z-10 mb-6 text-center">
        ...
        <div className="mt-3 font-display text-lg font-bold tracking-[-.04em] text-[#18332C]">{t("app.schoolName")}</div>
        <div className="mt-1 font-mono-campus text-[9px] uppercase tracking-[.18em] text-[#6C7D76]">{t("auth.campus")}</div>
      </div>
      <SignIn
        routing="path"
