  ...
  return (
    <div className="reveal animate-in fade-in slide-in-from-bottom-4 duration-500">
      <PageIntro
        ...
        detail="Your verified school credentials and profile settings."
      />
        ...
        <div className="relative w-full max-w-sm overflow-hidden rounded-[2rem] border-2 border-[#D9D1C2] bg-[#FBF9F4] p-8 shadow-sm">
          ...
          <div className="relative">
            <div className="flex items-center justify-between">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#25423A] font-bold text-white shadow-md">
                AM
              </div>
            ...
            <div className="mt-8">
              <div className="font-mono-campus text-[10px] uppercase tracking-[.2em] text-[#89958F]">
                Student Name
              </div>
